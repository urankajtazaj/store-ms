    ...
    private void exportDataFunc() {
        ...
        try (Statement st = con.createStatement()) {
            ...
            String view =
                    ...
                    "CREATE FORCE VIEW PUBLIC.TE_HYRAT AS SELECT HYRAT_MUAJ.FITIMI AS MUAJ, HYRAT_JAVA.FITIMI AS JAVA, HYRAT_SOT.FITIMI AS SOT, HYRAT_MUAJ.FITIMI_LEK AS MUAJ_LEK, HYRAT_JAVA.FITIMI_LEK AS JAVA_LEK, HYRAT_SOT.FITIMI_LEK AS SOT_LEK FROM HYRAT_MUAJ, HYRAT_JAVA, HYRAT_SOT;\n" +
